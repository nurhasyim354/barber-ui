...
export type UiBooking = {
  ...
  date: string;
  /** Slot janji (jam lokal kuota server) — hanya bila booking dengan staff. */
...
/** Label singkat untuk slot janji di UI / nota. */
export { formatAppointmentSlotLabel } from './bookingAppointmentSlots';
